...
class matchTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user2 = User.objects.create_user(username="test2", email="test@test2.com", password="test122")
    ...
    def test_game_type_choices(self):
        ...
        choices = [choice[0] for choice in Match._meta.get_field('game_type').choices]
