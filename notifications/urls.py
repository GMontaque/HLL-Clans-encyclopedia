...
urlpatterns = [
    ...
    path('notification/<int:notification_id>/', views.show_notification,
         name='individual_notification'),
    # displays page to edit individual notification
    path('notification/<int:pk>/update/<str:status>/',
         views.update_notification_status, name='update_notification_status')
]
